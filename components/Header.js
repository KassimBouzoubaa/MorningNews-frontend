...
import { delAllHiddenArticles } from '../reducers/hiddenArticles';
		...
		if (isModalVisible) {
			userSection =
				<div className={styles.headerIcons}>
					...
					<FontAwesomeIcon onClick={() => delTout()} className={styles.userSection} icon={faEye} />
